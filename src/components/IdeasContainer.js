...
class IdeasContainer extends Component {
  ...
  componentDidMount() {
    axios.get('https://crossorigin.me/https://ideaboardapi.herokuapp.com/api/v1/ideas.json')
    .then(response => {
  ...
  addNewIdea = () => {
    axios.post('https://crossorigin.me/https://ideaboardapi.herokuapp.com/api/v1/ideas', {idea: {title: '', body: ''}})
    .then(response => {
  ...
  deleteIdea = (id) => {
    axios.delete(`https://crossorigin.me/https://ideaboardapi.herokuapp.com/api/v1/ideas/${id}`)
    .then(response => {
